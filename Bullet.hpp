...
private:
	...
	static constexpr float BULLET_DIFFUSION_RADIUS = 0.95f;  // 拡散弾
	static constexpr float BULLET_JUMPATTACK_RADIUS = 0.55f;  // 拡散弾
	static constexpr float BULLET_HOMING_RADIUS = 0.95f;     // 追尾弾
